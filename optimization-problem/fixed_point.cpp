...
int main(int argc, char** argv) {
  ...
  // Print singleton array before starting the search
  std::cout << "Initial singleton array: ";
  root.print_singleton();
  ...
  // Print singleton array after the search
  std::cout << "Final singleton array: ";
  root.print_singleton();
